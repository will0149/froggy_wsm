...
@riverpod
Future<BaseResponseEntity<List<StockEntity>>> getStocksByColumName(GetStocksByColumNameRef ref, Map<String, String>? request) async {
  return ref.read(stocksLogicProvider).getStocksByColumnName(request);
}